...
var union = Object.freeze({
	CascadedPolygonUnion: CascadedPolygonUnion,
	PointGeometryUnion: PointGeometryUnion,
	UnaryUnionOp: UnaryUnionOp,
	UnionInteracting: UnionInteracting,
	UnionOp: UnionOp
});
	...
	query: function query() {
		...
		if (arguments.length === 1) {
			...
			if (arguments[0] instanceof Envelope && hasInterface(arguments[1], List)) {
				(function () {
					var queryEnv = _arguments[0],
					    result = _arguments[1];
					_this.queryNode(_this.root, queryEnv, true, {
						interfaces_: function interfaces_() {
							return [KdNodeVisitor];
						},
						visit: function visit(node) {
				...
				var _queryEnv = arguments[0],
				    visitor = arguments[1];
				this.queryNode(this.root, _queryEnv, true, visitor);
			}
		}
	},
